...
const PAGE_TEXT = {
  TH: {
    ...
    advisor_position: "อาจารย์ประจำสาขาวิทยาการคอมพิวเตอร์ประยุกต์-มัลติมีเดีย มจธ." 
  },
  ENG: {
...
export default function AboutPage() {
  ...
  return (
    // 1. เปลี่ยน container หลักให้เป็น w-full เหมือนหน้า Home (เอา max-w-3xl ออกจากตรงนี้)
    <main className="w-full px-6 pb-20 mx-auto"> 
      
      <Navbar />

      {/* 2. สร้าง div ใหม่มาครอบเนื้อหา แล้วย้าย max-w-3xl มาไว้ตรงนี้แทน */}
